...
describe('Contact CRUD tests', function () {
          ...
          .end(function (contactSaveErr, contactSaveRes) {
            ...
            agent.get('/api/contacts')
              .end(function (contactsGetErr, contactsGetRes) {
                ...
                (contacts[0].lastname).should.match('lastname');
  ...
  it('should not be able to save an Contact if no lastname is provided', function (done) {
    // Invalidate lastname field
    contact.lastname = '';
      ...
      .end(function (signinErr, signinRes) {
        ...
        agent.post('/api/contacts')
          ...
          .end(function (contactSaveErr, contactSaveRes) {
            ...
            (contactSaveRes.body.message).should.match('Please fill lastname');
      ...
      .end(function (signinErr, signinRes) {
        ...
        agent.post('/api/contacts')
          ...
          .end(function (contactSaveErr, contactSaveRes) {
            ...
            contact.lastname = 'WHY YOU GOTTA BE SO MEAN?';
            ...
            agent.put('/api/contacts/' + contactSaveRes.body._id)
              ...
              .end(function (contactUpdateErr, contactUpdateRes) {
                ...
                (contactUpdateRes.body.lastname).should.match('WHY YOU GOTTA BE SO MEAN?');
  ...
  it('should be able to get a single Contact if not signed in', function (done) {
    ...
    contactObj.save(function () {
      request(app).get('/api/contacts/' + contactObj._id)
        .end(function (req, res) {
          // Set assertion
          res.body.should.be.instanceof(Object).and.have.property('lastname', contact.lastname);
        ...
        .end(function (signinErr, signinRes) {
          ...
          agent.post('/api/contacts')
            ...
            .end(function (contactSaveErr, contactSaveRes) {
              ...
              (contactSaveRes.body.lastname).should.equal(contact.lastname);
                  ...
                  .end(function (err, res) {
                    ...
                    agent.get('/api/contacts/' + contactSaveRes.body._id)
                      ...
                      .end(function (contactInfoErr, contactInfoRes) {
                        ...
                        (contactInfoRes.body.lastname).should.equal(contact.lastname);
